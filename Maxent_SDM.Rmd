...
params:
  ...
  Workdir: 
    ...
    value: "D:/temp/SDM_Herpetofauna/Maxent_HighRes/"
    input: text
  Ncores:
...
# sapply(LU_list, res)
# sapply(LU_list, dim)
# LU_list[[1]] <- terra::resample(LU_list[[1]], LU_list[[2]])
...
# worldclim_data_resampled <- terra::resample(worldclim_data, LandUse)
# 
# # save
...
# 
# fut <- terra::resample(fut, LandUse)
# fut2 <- terra::resample(fut2, LandUse)
# 
...
fut_predictors <- rast(paste0(params$Workdir,"fut_LUpredictors.tif"))
fut2_predictors <- rast(paste0(params$Workdir,"fut2_LUpredictors.tif"))
fut <- rast(paste0(params$Workdir,"worldclim_fut.tif"))
fut2 <- rast(paste0(params$Workdir,"worldclim_fut2.tif"))
```
